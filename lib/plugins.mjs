...
const KNOWN_MARKETPLACES = [
  {
    ...
    desc: 'VoltAgent specialized subagents (core-dev, research, infra, lang, etc.)',
  },
  {
    name: 'supabase-agent-skills',
    repo: 'supabase/agent-skills',
    desc: 'Supabase Postgres best practices and skills',
  },
  {
    name: 'payload-marketplace',
    repo: 'payloadcms/payload',
    desc: 'Payload CMS plugin for collections, hooks, access control',
  },
];
