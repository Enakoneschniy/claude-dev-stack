...
function generateSkillsSection() {
  ...
  section += `- **TeamCreate worktrees**: agents in worktrees must NOT modify \`.planning/\` files (STATE.md, ROADMAP.md, REQUIREMENTS.md). Only commit code (lib/, tests/, hooks/, templates/, skills/, bin/). Team lead updates \`.planning/\` on main after merge.\n\n`;
