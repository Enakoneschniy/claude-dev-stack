...
export function installSessionHook(stepNum, totalSteps, pkgRoot, vaultPath, projectsData) {
  ...
  for (const name of ['session-start-context.sh', 'session-end-check.sh', 'vault-auto-push.sh', 'gsd-auto-reapply-patches.sh', 'budget-check.mjs', 'budget-reset.mjs', 'budget-check-status.mjs', 'gsd-workflow-enforcer.mjs', 'dev-router.mjs', 'project-switcher.mjs', 'git-conventions-check.mjs']) {
...
function _writeSettingsFile(settingsPath, startDest, endDest, pushDest, vaultPath) {
  ...
  // matcher narrows to Bash; per-hook `if` narrows to the commit subcommand
