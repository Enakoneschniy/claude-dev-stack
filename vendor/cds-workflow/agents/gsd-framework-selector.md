...
description: Presents an interactive decision matrix to surface the right AI/LLM framework for the user's specific use case. Produces a scored recommendation with rationale. Spawned by /cds-ai-integration-phase and /cds-select-framework orchestrators.
...
<required_reading>
Read `$HOME/.claude/cds-workflow/references/ai-frameworks.md` before asking questions. This is your decision matrix.
</required_reading>
