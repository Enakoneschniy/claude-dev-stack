...
<reference>
@$HOME/.claude/cds-workflow/references/user-profiling.md
...
Read the user-profiling reference document at `$HOME/.claude/cds-workflow/references/user-profiling.md` to load:
