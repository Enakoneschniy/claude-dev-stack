...
<!-- For checkpoint task examples and patterns, see @$HOME/.claude/cds-workflow/references/checkpoints.md -->
...
See `$HOME/.claude/cds-workflow/references/tdd.md` for TDD plan structure.
...
See `$HOME/.claude/cds-workflow/templates/user-setup.md` for full schema and examples
...
See `$HOME/.claude/cds-workflow/workflows/verify-phase.md` for verification logic.
