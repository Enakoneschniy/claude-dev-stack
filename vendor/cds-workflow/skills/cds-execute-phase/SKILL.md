...
<execution_context>
@$HOME/.claude/cds-workflow/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @$HOME/.claude/cds-workflow/workflows/execute-phase.md end-to-end.
