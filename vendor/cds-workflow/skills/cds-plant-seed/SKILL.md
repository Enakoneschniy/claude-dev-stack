...
Consumed by: /cds-new-milestone (scans seeds and presents matches)
</objective>

<execution_context>
@$HOME/.claude/cds-workflow/workflows/plant-seed.md
</execution_context>

<process>
Execute the plant-seed workflow from @$HOME/.claude/cds-workflow/workflows/plant-seed.md end-to-end.
</process>
