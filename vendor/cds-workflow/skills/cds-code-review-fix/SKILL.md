...
<execution_context>
@$HOME/.claude/cds-workflow/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @$HOME/.claude/cds-workflow/workflows/code-review-fix.md end-to-end.
