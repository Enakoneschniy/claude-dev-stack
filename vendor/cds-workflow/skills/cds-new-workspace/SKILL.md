...
- `--path` — Target directory. Defaults to `~/cds-workspaces/<name>`
...
**After this command:** `cd` into the workspace and run `/cds-new-project` to initialize GSD.
</objective>

<execution_context>
@$HOME/.claude/cds-workflow/workflows/new-workspace.md
@$HOME/.claude/cds-workflow/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @$HOME/.claude/cds-workflow/workflows/new-workspace.md end-to-end.
