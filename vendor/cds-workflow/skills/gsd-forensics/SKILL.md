...
<execution_context>
@$HOME/.claude/cds-workflow/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @$HOME/.claude/cds-workflow/workflows/forensics.md end-to-end.
</process>
