...
<execution_context>
@$HOME/.claude/cds-workflow/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @$HOME/.claude/cds-workflow/workflows/docs-update.md end-to-end.
