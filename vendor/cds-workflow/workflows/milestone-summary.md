...
4. If nothing found: error "No milestone found. Run /cds-new-project or /cds-new-milestone first."
...
If the user is done:
- Suggest next steps: `/cds-new-milestone`, `/cds-progress`, or sharing the summary with the team
