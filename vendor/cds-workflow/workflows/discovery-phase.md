...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /cds-research-phase instead, which produces RESEARCH.md.
</purpose>
...
See $HOME/.claude/cds-workflow/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $HOME/.claude/cds-workflow/templates/discovery.md structure:
...
1. **Scope the discovery** using $HOME/.claude/cds-workflow/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $HOME/.claude/cds-workflow/templates/discovery.md
...
Use $HOME/.claude/cds-workflow/templates/discovery.md.
...
1. Discuss phase context (/cds-discuss-phase [current-phase])
2. Create phase plan (/cds-plan-phase [current-phase])
