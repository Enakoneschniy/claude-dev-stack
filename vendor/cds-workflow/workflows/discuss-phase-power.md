...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/cds-discuss-phase`.
...
Consider running /cds-discuss-phase {N} again to refine before planning.
```
